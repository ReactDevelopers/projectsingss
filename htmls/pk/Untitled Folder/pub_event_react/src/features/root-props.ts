 ...
 */
export interface ServerResponse<data= any, formError=FormErrors, FilterDataType= string> {
 ...
 */
export interface ServerResponseListData<DataModel= object, FilterDataType=string> {
    total: number;
    per_page: number;
    current_page : number;
    last_page : number;
