...
class UsersController extends Controller {
     ...
     * Updating the config
     * @param  Request $request [description]
     * @param  [number]  key=>value pair
     * @return [Json] 
     */
    public function updateConfig(Request $request){

        $validator = \Validator::make($request->all(),[
                'email_threshold_tenure'=>'required'
            ]
        );
        ...
        if($validator->fails()){
            ...
            $this->message = 'Configuration values has been updated.';
            $this->data = \App\Models\Configuration::where('key','email_threshold_tenure')->update(['value' => $request->email_threshold_tenure]);
        }
    ...
    public function getConfig(Request $request){
        ...
        $this->data = \App\Models\Configuration::select('key','value')->pluck('value','key');
