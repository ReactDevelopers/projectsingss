...
class EmailTemplateSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        <div style="border: 1px;">
            ...
            'subject'   => "TRAINING NOTIFICATION - COURSE CONFIRMATION NOTIFICATION - {COURSE_TITLE} {START_DATE}",
            'type'      => "1",
        ...
        [
            ...
            <p style="font-size: 14px;">This is an automated reminder from SgWA to you to attend the abovementioned course.</p><strong>Course Details:</strong></div>
        ...
        ',
            'subject'   => "TRAINING NOTIFICATION - COURSE CANCELLATION NOTIFICATION - {COURSE_TITLE} {START_DATE}",
            'type'      => "2",
            'created_at'=> date('Y-m-d H:i:s')
        ]
        ]); 
