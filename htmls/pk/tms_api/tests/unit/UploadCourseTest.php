...
class UploadCourseTest extends ColumnTestCase
{
    ...
    public function test_grantsubsidy_yn() {
        ...
        $this->setColumn('grantsubsidy_yn');
        ...
        # When  value is yes but y is in small letter
        $this->createNewData()->setValue('yes')->setvalue(1,'if_yes_provide_value')
            ->checkColumn(true)
            ->checkTraslateValue('Yes','subsidy');

        # When  value is no but n is in small letter
        $this->createNewData()->setValue('no')
            ->setvalue(null,'if_yes_provide_value')
            ->checkColumn(true)
            ->checkTraslateValue('No' ,'subsidy');

        # When  value is caps
        $this->createNewData()
            ->setValue('YES')
            ->setvalue(1,'if_yes_provide_value')
            ->checkColumn(true)
            ->checkTraslateValue('Yes', 'subsidy');
        ...
        # When  valid data
        $this->createNewData()->setValue('Yes')->setvalue(1, 'if_yes_provide_value')->checkColumn(true);

        # When  valid data
        $this->createNewData()->setValue('No')->setvalue(null, 'if_yes_provide_value')->checkColumn(true);
    }
    ...
    public function test_vendor_contactemail_account() {
        ...
        $this->setColumn('vendor_contactemail_account');
