...
class FilesHeaderVerify {
    ...
    public $courseCell = [
        ...
        'dept_competency_level_if_applicable'=>     'Dept/ Competency Level (if applicable)',
        ...
        'grantsubsidy_yn'=>                         'Grant/Subsidy (Y/N)',
        'if_yes_provide_value'=>                    'if yes, provide value ($)',
        'vendor_contactemail_account'=>             'Vendor Contact/Email Account'
    ];
