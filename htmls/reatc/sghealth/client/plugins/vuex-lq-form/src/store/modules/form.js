...
const actions = {
	...
	doSubmit({commit}, {formName}) {

		commit('submitAction', {formName});
	},
...
const mutations = {
	...
	submitAction(state, {formName}){

		const submitEvent = helper.getProp(state, `${formName}.submitEvent`, false);
		helper.setProp(state, `${formName}.submitEvent`, !submitEvent);
	},
