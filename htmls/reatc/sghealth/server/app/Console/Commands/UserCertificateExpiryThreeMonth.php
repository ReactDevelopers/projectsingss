...
class UserCertificateExpiryThreeMonth extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'certificate:three_month_expiry';
    ...
    public function handle()
    {
        ...
        ->where('cenl.id',null)
        ->whereRaw('12 *( YEAR(expiry_date) - YEAR(NOW())) +( MONTH(expiry_date) - MONTH(NOW()))= 3')->get();
        ...
        SendPushNotificationJob::dispatch($user_ids,[],'certificate_expire','Your certificate will expire soon','Your certificate will expires in 3 months please renew it as soon as possible.');
    }
}
