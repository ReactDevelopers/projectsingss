            ...
            <div class="box-header with-border">
              <div class="col-md-8">
                ...
                <div class="col-md-4 text-right">
                  <a href="{{ url('banners/create') }}" class="btn btn-default">Add Banner</a>
                </div>
            </div>
