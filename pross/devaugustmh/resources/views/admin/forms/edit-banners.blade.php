                ...
                {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <img width="200" src="{{asset('uplodes/banner/'.$dataRow->banner_image)}}">
                    </div>
                     ...
                     <div class="form-group @if ($errors->has('banner_image'))has-error @endif">
                      ...
                      <p class="help-block">For best resolution, please upload a image of 1928 * 642</p>
                        <input type="hidden" class="form-control" id="old_image" name="old_image"  value="{{ $dataRow->banner_image }}">
                      </div> 
