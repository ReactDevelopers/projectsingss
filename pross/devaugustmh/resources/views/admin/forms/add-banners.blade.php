      ...
      <!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form role="form" method="post" action="{{ url('banners')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                  <div class="box-body">
                    
                    <div class="form-group @if ($errors->has('banner_name'))has-error @endif">
                      <label for="banner_name">Banner Name</label>
                      <input type="text" class="form-control" id="banner_name" name="banner_name" maxLength = "200" placeholder="Banner Name" value="{{ (old('banner_name')) }}">
