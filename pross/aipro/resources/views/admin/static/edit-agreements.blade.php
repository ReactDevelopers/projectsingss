              ...
              <form role="form" method="post" action="{{ url('admin/static/'.$static->alias)}}" enctype="multipart/form-data">
                ...
                {{ csrf_field() }}
                  ...
                  <div class="box-body">
                    ...
                    @if($static->document_1) 
                    <div class="form-group">
                      <label for="designation">Document 1:</label>
                      <a href="{{asset('admin/download/'.$static->document_1)}}" target="_blank">Download Here</a>
                      <p class="help-block">
                        <input name="delete_document_1" value="1" class="checkbox" id="delete_document_1" type="checkbox"> <label for="delete_document_1">Delete Document</label>
                      </p>
                    </div>
                    @endif
                     <div class="form-group @if ($errors->has('document_1'))has-error @endif">
                      <label for="document_1">Document 1</label>
                      <input type="file" id="document_1" name="document_1" class="form-control">
                      @if ($errors->has('document_1'))
                        <span class="help-block">
                        {{ $errors->first('document_1')}}
                        </span>
                      @endif
                      <p class="help-block">Only upload PDF file.</p>
                        <input type="hidden" class="form-control" id="old_document_1" name="old_document_1"  value="{{ $static->document_1 }}">
                      </div>
                    ...
                    @if($static->document_2) 
                    <div class="form-group">
                      <label for="designation">Document 2:</label>
                      <a href="{{asset('admin/download/'.$static->document_2)}}" target="_blank">Download Here</a>
                      <p class="help-block">
                        <input name="delete_document_2" value="1" class="checkbox" id="delete_document_2" type="checkbox"> <label for="delete_document_2">Delete Document</label>
                      </p>
                    </div>
                    @endif
                     <div class="form-group @if ($errors->has('document_2'))has-error @endif">
                      <label for="document_2">Document 2</label>
                      <input type="file" id="document_2" name="document_2" class="form-control">
                      ...
                      @endif
                      <p class="help-block">Only upload PDF file.</p>
                        <input type="hidden" class="form-control" id="old_document_2" name="old_document_2"  value="{{ $static->document_2 }}">
                      </div>
                    ...
                    <div class="form-group">
                      <label for="sub_title_9">Heading 9</label>
                      <input type="text" class="form-control" id="sub_title_9" name="sub_title_9" placeholder="Heading 8" value="{{ (old('sub_title_9')) ? old('sub_title_9') : $static->sub_title_9 }}">
                    </div>
                    <div class="form-group">
                      <label for="description_9">Description 9:</label>
                      <textarea class="form-control" id="description_9" name="description_9">{{ (old('description_9')) ? old('description_9') : $static->description_9 }}</textarea>
                    </div>
...
<script type="text/javascript">
  $(function() {
    ...
    CKEDITOR.replace('description_9');
