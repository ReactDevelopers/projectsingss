...
<!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form role="form" method="post" action="{{ url('admin/email-template/'.$template->email_template_id)}}">
                ...
                {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <a href="{!!url('admin/email-template')!!}" class="btn btn-warning" title="Back">Back</a>&nbsp;&nbsp;&nbsp;
