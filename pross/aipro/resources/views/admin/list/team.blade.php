            ...
            <div class="box-header with-border">
              <div class="col-md-8">
                ...
                <div class="col-md-4 text-right">
                  <a href="{{ url('team/create') }}" class="btn btn-default">Add Team</a>
                </div>
            </div>
