      ...
      <!-- general form elements disabled -->
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <form role="form" method="post" action="{{ url('team/'.$dataRow->id)}}" enctype="multipart/form-data">
                ...
                {{ csrf_field() }}
                  <div class="box-body">
                    ...
                    <div class="form-group @if ($errors->has('email'))has-error @endif">
                      ...
                      <input type="text" class="form-control" id="email" name="email" placeholder="Email" value="{{ (old('email')) ? old('email') : $dataRow->email }}">
                      @if ($errors->has('email'))
                        <span class="help-block">
                        {{ $errors->first('email')}}
                        </span>
                    ...
                    @if($dataRow->profile_image)
                    <div class="form-group">
                      <label for="designation">Image:</label>
                      <img width="150" src="{{asset('uplodes/profile/'.$dataRow->profile_image)}}">
                    </div>
                    @endif
                    ...
                    <div class="form-group @if ($errors->has('designation'))has-error @endif">
                      ...
                      <input type="text" class="form-control" id="designation" name="designation" placeholder="Designation" value="{{ (old('designation')) ? old('designation') : $dataRow->designation }}">
                    ...
                    <div class="form-group @if ($errors->has('facebook_url'))has-error @endif">
                      ...
                      <input type="text" class="form-control" id="facebook_url" name="facebook_url" placeholder="Facebook URL" value="{{ (old('facebook_url')) ? old('facebook_url') : $dataRow->facebook_url }}">
                      ...
                      <input type="text" class="form-control" id="skype_url" name="skype_url" placeholder="Skype" value="{{ (old('skype_url')) ? old('skype_url') : $dataRow->skype_url }}">
                      ...
                      <input type="text" class="form-control" id="twitter_url" name="twitter_url" placeholder="Twitter URL" value="{{ (old('twitter_url')) ? old('twitter_url') : $dataRow->twitter_url }}">
                    ...
                    <div class="form-group @if ($errors->has('linkedin_url'))has-error @endif">
                      ...
                      <input type="text" class="form-control" id="linkedin_url" name="linkedin_url" placeholder="Linkedin URL" value="{{ (old('linkedin_url')) ? old('linkedin_url') : $dataRow->linkedin_url }}">
                    ...
                    <div class="form-group @if ($errors->has('google_plus_url'))has-error @endif">
                      ...
                      <input type="text" class="form-control" id="google_plus_url" name="google_plus_url" placeholder="Google Plus URL" value="{{ (old('google_plus_url')) ? old('google_plus_url') : $dataRow->google_plus_url }}">
