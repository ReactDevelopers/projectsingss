...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="{{ url('/home') }}" method="post">
      ...
      <div class="form-group has-feedback {{ $errors->feature1->has('email') ? ' has-error' : '' }}">
      ...
      <div class="form-group has-feedback {{ $errors->feature1->has('password') ? ' has-error' : '' }}">
